...
output: pdf_document
---
This code has several section, each section starts with a line of #s and ends with three #s (###) followed by starts (*)
The sections that were used to make the figures for the paper were (NOTE: the title for the section is right above the # line):
...
metadir1 <- 'C:/Users/adelpinoherrera/Dropbox (UFL)/research-share/Adriana/scRNAseq/data/Metabolic Pathway Analysis/Ovarian Set/Specific pathways analysis/OvarianSet_Seurat-Specific-Analysis_Right_Color_'
...
```{r}
#Ovarian Set 
##Right color for purine metabolism
pdf(paste(metadir1,"UMAP_Purine-Score",date,".pdf",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='purineMet1', cols = c("gray95", "#AD07E3")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
#SAVE as PNG
png(paste(metadir1,"UMAP_Purine-Score",date,".png",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='purineMet1', cols = c("gray95", "#AD07E3")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
...
print(dPlot)
dev.off()
#Right color for the DeNovo Purine metabolism 
pdf(paste(metadir1,"UMAP_Purine_DeNovo-Score",date,".pdf",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='PuDeNovo1', cols = c("gray95", "#DE8AF9")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
##SAVE as PNG
png(paste(metadir1,"UMAP_Purine_DeNovo-Score",date,".png",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='PuDeNovo1', cols = c("gray95", "#DE8AF9")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
...
print(dPlot)
dev.off()
#right color for the salvage Purine metabolism
pdf(paste(metadir1,"UMAP_Purine_Salvage-Score",date,".pdf",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='PuSalvage1', cols = c("gray95", "#760699")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
#SAVE as PNG
png(paste(metadir1,"UMAP_Purine_Salvage-Score",date,".png",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='PuSalvage1', cols = c("gray95", "#760699")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()

##Right color for the pyrimidine metabolism
pdf(paste(metadir1,"UMAP_Pyrimidine-Score_green",date,".pdf",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='pyrimidineMet1', cols = c("gray95", "#00C000")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
#SAVE as PNG
png(paste(metadir1,"UMAP_Pyrimidine-Score",date,".png",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='pyrimidineMet1', cols = c("gray95", "#00C000")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
...
print(dPlot)
dev.off()
#Right color for the DeNovo pyrimidine metabolism
pdf(paste(metadir1,"UMAP_Pyrimidine_DeNovo-Score",date,".pdf",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='PyDeNovo1', cols = c("gray95", "#13C984")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
#SAVE as PNG
png(paste(metadir1,"UMAP_Pyrimidine_DeNovo-Score",date,".png",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='PyDeNovo1', cols = c("gray95", "#13C984")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
...
print(dPlot)
dev.off()
#Right color for the salvage Pyrimidine metabolism
pdf(paste(metadir1,"UMAP_Pyrimidine_Salvage-Score",date,".pdf",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='PySalvage1', cols = c("gray95", "#038352")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
#SAVE as PNG
png(paste(metadir1,"UMAP_Pyrimidine_Salvage-Score",date,".png",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='PySalvage1', cols = c("gray95", "#038352")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
...
print(dPlot)
dev.off()
#Right color for the glutamine metabolism 
pdf(paste(metadir1,"UMAP_Glutamine-Score",date,".pdf",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='Glutamine1', cols = c("gray95", "#F71480")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
#SAVE as PNG
png(paste(metadir1,"UMAP_Glutamine-Score",date,".png",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='Glutamine1', cols = c("gray95", "#F71480")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
...
#Right color for glycolysis 
pdf(paste(metadir1,"UMAP_Glycolysis-Score",date,".pdf",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='glycolysis1', cols = c("gray95", "#D0C217")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
#SAVE as PNG
png(paste(metadir1,"UMAP_Glycolysis-Score",date,".png",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='glycolysis1', cols = c("gray95", "#D0C217")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()

#Right color for OXPHOS
pdf(paste(metadir1,"UMAP_OXPHOS-Score_red",date,".pdf",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='OXPHOS1', cols = c("gray95", "#C80001")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
#SAVE as PNG
png(paste(metadir1,"UMAP_OXPHOS-Score_red",date,".png",sep=""))
dPlot <- FeaturePlot(OvarianSetGrpd.1, features='OXPHOS1', cols = c("gray95", "#C80001")) + xlim(-14, 14) + ylim(-6, 6)
print(dPlot)
dev.off()
```
