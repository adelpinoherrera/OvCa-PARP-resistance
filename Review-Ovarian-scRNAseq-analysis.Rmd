...
output: pdf_document 
---
This code was developed as the initial steps when analyzing scRNA-seq data 
Looking at all the steps will be beneficial to understand the workflow for scRNA-seq data analysis 
